...
const courses = [
  {
    ...
    description: "Personalized Thai language instruction with flexible scheduling and individualized attention. Perfect for learners who want to progress at their own pace with dedicated support.",
    icon: Users,
    features: [
  ...
  },
  {
    ...
    description: "Tailored Thai language programs designed for businesses and organizations. Enhance your team's cultural competency and communication skills for better business relationships in Thailand.",
    icon: Building,
    features: [
  ...
  },
  {
    ...
    description: "Intensive cultural immersion experiences in Thailand. Learn Thai while experiencing authentic local culture, traditions, and daily life with native speakers.",
    icon: Globe,
    features: [
  ...
  },
  {
    ...
    description: "Essential Thai phrases and cultural knowledge for travelers. Learn to make simple conversations with locals and navigate Thailand with confidence.",
    icon: Heart,
    features: [
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            {courses.map((course) => {
              ...
              return (
                <Card key={course.id} className={`relative shadow-thai-medium transition-thai hover:shadow-thai-strong ${!course.available ? 'opacity-60' : ''}`}>
                  {course.popular && (
                  ...
                  <CardHeader className="pb-4">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-thai-gold font-semibold">{course.price}</p>
                      </div>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                        <div>
                          <p className="font-semibold text-thai-text-dark">Duration:</p>
                          <p className="text-muted-foreground">{course.duration}</p>
                        </div>
                        <div>
                          <p className="font-semibold text-thai-text-dark">Level:</p>
                          <p className="text-muted-foreground">{course.level}</p>
                        </div>
                      </div>
                      
                      <div>
                        <h4 className="font-semibold text-thai-text-dark mb-3">What's Included:</h4>
                      ...
                      <div className="pt-4">
                        ...
                        >
                          {course.available ? 'Enroll Now' : 'Notify When Available'}
                        </Button>
                      </div>
                    </div>
                  </CardContent>
      ...
      <section className="bg-thai-light-tint py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Not sure which course is right for you? Book a free consultation with our language experts 
            to discuss your goals and find the perfect program.
          </p>
