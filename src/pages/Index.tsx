...
import { Users, Building, Globe, Heart, Star, CheckCircle, BookOpen, Clock } from "lucide-react";
...
const Index = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      if (!lastClosed || new Date().getTime() - new Date(lastClosed).getTime() > 30 * 24 * 60 * 60 * 1000) {
  ...
  const courses = [
    ...
    },
    {
      ...
      description: "Tailored Thai language programs for businesses and organizations. Enhance your team's cultural competency and communication skills.",
      icon: Building,
      popular: false,
      available: true
    },
    {
      ...
      description: "Intensive cultural immersion experiences in Thailand. Learn Thai while experiencing authentic local culture and traditions.",
      icon: Globe,
      popular: false,
      available: true
    },
  ...
  const features = [
    {
      ...
      description: "We've meticulously designed our syllabus following the latest scientific research on language acquisition. We prioritize techniques proven to enhance retention, comprehension, and fluency.",
      icon: BookOpen
    },
    {
      title: "Experienced and Qualified Instructors", 
      description: "Our instructors aren't just native Thai speakers; every instructor has been handpicked based on their deep knowledge of the Thai language, proficiency in English/Chinese, and extensive teaching experience spanning decades.",
      icon: Users
    },
    {
      title: "Flexible Schedule",
      description: "We offer flexible schedules to accommodate your busy lifestyle. If you miss a lesson, we provide recordings of all classes for playback, and allow you to join another class group (subject to availability).",
      icon: Clock
    },
    {
      title: "Community",
      description: "Join our community at ThaiBridge, where Thai enthusiasts come together! Share travel tips, exchange Thai recipes, and uncover hidden gems in Thailand. Whether you're a seasoned traveler or new to Thai culture, there's a place for you.",
      icon: Heart
    }
  ];
      ...
      <section className="py-16 bg-thai-light-tint">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-2xl font-bold text-thai-text-dark ml-2">4.8/5 stars</span>
          </div>
          <p className="text-lg text-muted-foreground mb-6">From 200+ Happy Students</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground mb-6">
                <strong className="text-primary">We only have a simple goal: To help you foster deeper connections with the Thai culture.</strong>
              </p>
